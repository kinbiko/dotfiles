...
map(n, "<up>", ":keepjumps normal {zz<cr>") -- Previous paragraph
map(n, "<down>", ":keepjumps normal }zz<cr>") -- Next paragraph
...
map(n, "<localleader><leader>", "<cmd>noh<cr>") -- Clear search results
